...
wind_example_map <- ggplot() +
  ...
  scale_fill_viridis(option = "C", limits = c(0, 12), name = expression("Wind speed (ms"^-1*")"),
                     breaks = c(0,6,12), labels = c(0,6,12))  +
...
ggsave("RFB_Accel_Plots/Wind_selectivity_densities_new.png", height = 9, width = 7, dpi = 600)
...
# Call back the plot
plot <- image_read("RFB_Accel_Plots/Wind_selectivity_densities_new.png")
